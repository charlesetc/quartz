async function drawGraph(baseUrl, isHome, pathColors, graphConfig) {
  ...
  const node = graphNode
    ...
    .on("mouseover", function (_, d) {
      d3.selectAll(".node").attr("fill", "var(--g-node-inactive)")
      ...
      neighbourNodes.attr("fill", color)

      // highlight links
      linkNodes.attr("stroke", "var(--g-link-active)")
    ...
    .on("mouseleave", function (_, d) {
      d3.selectAll(".node").attr("fill", color)
      ...
      linkNodes.attr("stroke", "var(--g-link)")
